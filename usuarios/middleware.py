...
class PermissaoMiddleware:
    ...
    def __call__(self, request):
        ...
        try:
            ...
            # Se não tiver perfil, criar um padrão sensato em vez de assumir 'tecnico'.
            # Usuários staff ou superuser recebem perfil 'administrador', outros ficam como 'atendente'.
            default_tipo = 'administrador' if (request.user.is_superuser or request.user.is_staff) else 'atendente'
